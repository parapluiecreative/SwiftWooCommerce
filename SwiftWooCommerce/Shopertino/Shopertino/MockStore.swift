...
class MockStore {
    ...
    static var colors: [String] = ["#6979F8", "#3F3356", "#ffffff", "#F2B4C0"]
    static var sizes: [String] = ["XS", "S", "M", "L", "XL"]
    static var products = [
    ...
    static var orders = [
        ATCOrder(id: "1", shoppingCart: MockStore.shoppingCart(), customer: nil, address: nil, status: "Delivered", createdAt: Date()),
        ATCOrder(id: "2", shoppingCart: MockStore.shoppingCart(), customer: nil, address: nil, status: "Delivered", createdAt: Date()),
        ATCOrder(id: "1sda", shoppingCart: MockStore.shoppingCart(), customer: nil, address: nil, status: "Delivered", createdAt: Date()),
        ATCOrder(id: "134", shoppingCart: MockStore.shoppingCart(), customer: nil, address: nil, status: "Delivered", createdAt: Date()),
    ]
