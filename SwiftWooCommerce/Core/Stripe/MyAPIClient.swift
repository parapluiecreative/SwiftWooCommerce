...
class MyAPIClient: NSObject, STPCustomerEphemeralKeyProvider {
    ...
    func createPaymentIntent(price: Int, products: [ATCShoppingCartProduct], shippingMethod: PKShippingMethod?, country: String? = nil, completion: @escaping ((Result<String, Error>) -> Void)) {
