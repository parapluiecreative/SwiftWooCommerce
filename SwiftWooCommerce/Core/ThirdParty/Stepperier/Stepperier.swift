...
fileprivate struct Constants {
    ...
    static let defaultFont: UIFont = UIFont.systemFont(ofSize: 17.0, weight: .light)
}
...
extension Stepperier {
    ...
    internal func didUpdateValue(_ value: Int) {
        valueLabel.text = value.description
        updateSymbolsAppearanceState()
        self.delegate?.steperrier(self, didUpdateValueTo: value)
    }
